...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color backgroundForApp = const Color(0xFFF5F5F5);
  late Color accentBlue = const Color(0xFF5794F2);
  late Color accentGreen = const Color(0xFF89DC8C);
}
